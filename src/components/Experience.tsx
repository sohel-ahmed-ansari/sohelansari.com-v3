      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="space-y-12">
          {experiences.map((exp, index) => (
            <div
              key={index}
              className="relative pl-8 border-l-4 border-indigo-500 dark:border-indigo-400 pb-8 last:pb-0 group"
            >
              <div className="absolute -left-3 top-0 w-6 h-6 bg-indigo-500 dark:bg-indigo-400 rounded-full group-hover:scale-125 transition-transform duration-300"></div>
